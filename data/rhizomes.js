...
Eisenstein relates this to non-literary "writing" in pre-literate societies, such as the ancient use of pictures and images in sequence, that are therefore in "conflict". Because the pictures are relating to each other, their collision creates the meaning of the "writing".`
      ...
      },
      {
        ...
        title: 'Samsara, Critial Reception.'
      },
      {
        url: 'https://en.wikipedia.org/wiki/Koyaanisqatsi#Filming',
        title: 'Koyaanisqatsi, Filming.',
        extract: 'Fricke and Reggio chose to shoot unscripted footage and edit it into an hour-long film ... Footage of the [Pruitt–Igoe](https://en.wikipedia.org/wiki/Pruitt–Igoe) housing project was shot from a helicopter ... [[Ron Fricke](https://en.wikipedia.org/wiki/Ron_Fricke)] edited the footage into a 20-minute reel, but "without regard for message or political content".'
      }
    ]
  }
];
