...
export default ({ projects, posts }) => {
  ...
  <p class="index-intro">I'm a Melbourne-based freelance <strong>UI Developer</strong> with a background in design. I've been building user interfaces and user experience prototypes for six years. These days I focus on web apps in <a target="_blank" href="https://reactjs.org">React</a> and <a target="_blank" href="https://nextjs.org">Next.js</a>.</p>
