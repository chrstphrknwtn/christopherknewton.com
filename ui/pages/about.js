...
export default () => {
  const content = ragtag`
    <section class="entry">
      ...
      <p>For the last two years I've been working on <a target="_blank" href="https://fieldfolio.com">Fieldfolio</a>.</p>
