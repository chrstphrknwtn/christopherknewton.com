...
export default () => {
  const content = ragtag`
    <section class="page">
      <p class="home--intro">I'm a developer from Melbourne with a background in design. I've been creating  interactive things for about ten years. These days I'm mostly building <em>&</em> maintaining ${externalLink({ href: 'https://nextjs.org', text: 'Next.js' })} apps.</p>
